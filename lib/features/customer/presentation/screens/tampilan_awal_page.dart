            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      // Fungsi untuk berpindah ke halaman Keranjang
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const KeranjangPage()),
                        ).then((_) {
                          // Refresh halaman saat kembali dari keranjang agar data tetap sinkron
                          setState(() {});
                          });
                          },
                          child: Stack(
                            ...
                            children: [
                              Image.asset(
                                ...
                                // Lingkaran merah penanda (Badge) jika ada isi keranjang
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      '${KeranjangPage.listKeranjangGlobal.length}',
