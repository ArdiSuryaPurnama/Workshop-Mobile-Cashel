...
import '../screens/detail_produk_screen.dart'; // Import halaman detail
...
class ProdukCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Membungkus dengan GestureDetector agar bisa diklik
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: const Color(0xFF3498DB), borderRadius: BorderRadius.circular(10 * scale)),
